...
export default function CustomerSidebar({ 
  ...
  const menuItems = useMemo(() => [    {      title: 'Home',      icon: Home,      href: '/customer/dashboard',    },    {      title: 'Browse Restaurants',      icon: Store,      href: '/customer/restaurants',    },    {      title: 'Order History',      icon: History,      href: '/customer/orders',    },    {      title: 'Rewards',      icon: Award,      href: '/customer/rewards',    },    {      title: 'Profile',      icon: User,      href: '/customer/profile',    },    {      title: 'Settings',      icon: Settings,      href: '/customer/settings',    },  ], []);
